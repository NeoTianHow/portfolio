...
function FooterIcon({
  ...
  return (
    <a
      ...
      className="grid size-11 place-items-center border border-[color:var(--line-strong)] bg-[color:var(--panel-soft)] text-[color:var(--muted)] transition-[color,border-color,transform] duration-200 ease-[var(--ease-out-quart)] hover:-translate-y-0.5 hover:border-[color:var(--accent)] hover:text-[color:var(--accent)] active:translate-y-0"
    >
      {children}
    </a>
  );
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3">
        ...
        <FooterIcon href="/#contact" label="Contact Neo">
