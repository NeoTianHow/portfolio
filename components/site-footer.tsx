...
export function SiteFooter() {
  return (
    <footer
      id="contact"
      className="mx-auto flex w-full max-w-[1014px] flex-col gap-5 px-5 pb-8 pt-3 text-sm text-[color:var(--muted)] sm:flex-row sm:items-center sm:justify-between sm:px-8"
    >
      <p>
        (c) 2026 {profile.name.toLowerCase().replaceAll(" ", "")}.com | privacy
      </p>
